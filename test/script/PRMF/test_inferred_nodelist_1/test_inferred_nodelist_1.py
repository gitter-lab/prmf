...
sp.check_call(args=['prmf.py', "--data", "data.tsv", "--manifolds"] + manifold_fps + ['--node-attribute', 'name', "--nodelist", 'nodelist.txt', "--outdir", os.curdir, '--delimiter', '\t', '--seed', "1"], stdout=open('test_inferred_nodelist_1.1.out', 'w'), stderr=open('test_inferred_nodelist_1.1.err', 'w'))
...
sp.check_call(args=['prmf.py', "--data", "data_header.tsv", "--manifolds"] + manifold_fps + ['--node-attribute', 'name', "--outdir", os.curdir, '--delimiter', '\t', '--seed', "1"], stdout=open(os.devnull, 'w'), stderr=open(os.devnull, 'w'))
sp.check_call(args=['diff', '-q', 'test_inferred_nodelist_1_expected_obj.txt', 'obj.txt'])
