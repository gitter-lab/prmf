...
""")
  ...
  attrs = {
    ...
    'args': ['--nmf-gene-by-latent', prmf_random_gene_by_latent_fp, '--prmf-gene-by-latent', prmf_true_gene_by_latent_fp, '--nodelist', nodelist_fp, '--true-seeds', chosen_seeds_fp, '--outdir', plot_outdir],
